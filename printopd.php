...
<img src="images/invoice.png" width="40%" class="center-block img-rounded" aligh>
</div>
</div>
...
<form class="" action="" method="post" id="upform">
  ...
  <table height="500" width="500">
    ...
    <tr>
      ...
      <td width="250"><strong>Dollar. <?php echo $row["medi_charge"]; ?>.00</strong></td>
    </tr>
    <tr>
      <td width="200"><strong>Price for Doctors : </strong></td>
      <td width="250"><strong>Dollar. <?php echo $row["doc_charge"]; ?>.00</strong></td>


    <tr>
      <td ><strong>Service Charge : </strong></td>
      <td ><strong>Dollar. <?php echo $row["hos_charge"]; ?>.00</strong></td>
    </tr>
    <tr>
      <td ><strong>Tolat Price : </strong></td>
      <td ><strong>Dollar. <?php echo $row["total_charge"]; ?>.00</strong></td>
    </tr>
  </table>
<br>
